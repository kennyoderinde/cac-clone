...
const Home = () => {
  return (
    ...
    <div className='sm:max-w-full sm:h-full'>
      <img src={cacBuilding} alt='' className='sm:w-full sm:h-full sm:mt-28  w-full h-full mt-24 '/>
      <h1 className=' sm:flex sm:items-center sm:justify-center sm:text-8xl sm:font-light flex flex-wrap items-center text-center justify-center px-4 text-4xl font-light sm:-mt-80 -mt-32  delay-700 duration-700' style={{ fontFamily: 'Roboto Slab' }}>Nigerian Corporate Registry</h1>
      
      <div className='  mt-20 m p-10 sm:flex sm:items-center sm:justify-center sm:space-x-20 sm:mt-60 sm:p-14'>
    ...
    <div className='  w-full h-16 -top-8 sm:w-full sm:h-24 sm:-top-8 rounded-t-full  bg-[#ebe8e5] '></div>

    <Cards />

      {/* Text: Step by step registration */}
    <div className=' text-5xl sm:text-7xl font-light text-lime-700 sm:flex sm:justify-center text-center sm:-mt-32 -mt-40 leading-normal' style={{ fontFamily: 'Roboto Slab' }}>Step by step registration </div>


    {/* displays the 3 icons */}
    <CircleIcon />
    <div className='w-full h-screen mt-[36rem] sm:mt-4'>
